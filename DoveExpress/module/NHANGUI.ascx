...
<telerik:RadGrid ID="RadGridNHANGUI" runat="server" Skin="Vista" 
    ...
    <MasterTableView Name="MasterTableViewNHANGUI" CommandItemDisplay="Top" DataSourceID="NHANGUIDataSource" DataKeyNames="PK_ID,C_BILL" ClientDataKeyNames="PK_ID,C_BILL" EditMode="PopUp" NoMasterRecordsText="Không có dữ liệu">
        <CommandItemTemplate>
