...
<table class="gridtable">
    <tr>
        ...
        <th width="15%">Nhập nhanh bằng số Bill
        </th>
        <th width="15%">Đối tác
        </th>
        <th width="15%">Lọc Bill theo file Excel
        </th>
        <th width="15%">Nhập Bill từ bảng kê Excel
        </th>
    </tr>
    <tr>
        <td>
            Tháng:&nbsp;
        <telerik:RadComboBox ID="cmbMonth" runat="server"  Width="25%" OnClientSelectedIndexChanged="cmbMonthClientSelectedIndexChangedHandler"
        ...
        Năm:&nbsp;
        <telerik:RadComboBox ID="cmbYear" runat="server"  Width="20%" OnClientSelectedIndexChanged="cmbYearClientSelectedIndexChangedHandler"
        ...
        <td>
         ...
         <td>
                <telerik:RadAsyncUpload runat="server" ID="RadAsyncUploadImport" Width="20%" HideFileInput="false" Localization-Select="Chọn" InputSize="20"
        ...
        <td>
                <telerik:RadAsyncUpload runat="server" ID="RadAsyncUploadAddExcel" Width="20%" HideFileInput="false" Localization-Select="Chọn" InputSize="20"
                    AllowedFileExtensions="xls,xlsx" MaxFileSize="1048576000">
                </telerik:RadAsyncUpload>
                    ...
                    <div style="width: 900px; height: 500px; background: #FFFFFF" class="clearfix">
                        <table id="tblEdit" class="TableEditInGrid" cellspacing="3" cellpadding="3" style="width: 100%"
                            ...
                            <tr>
                                ...
                                <td colspan="4">
                                    <telerik:RadComboBox ID="cmbMaKhachHang" runat="server" OnClientLoad="OnClientLoadcmbMaKhachHang"
                                        ...
                                        SelectedValue='<%# CheckKhachHang(Eval("FK_KHACHHANG")) %>' ShowToggleImage="True" EmptyMessage="Chọn mã"
                            ...
                            <tr>
                                ...
                                <td colspan="4">
                                    <telerik:RadComboBox ID="cmbFK_USERADD" runat="server" SelectedValue='<%# CheckUSERADD(Eval("FK_USERADD")) %>' 
                            ...
                            <tr>
                                ...
                                <td colspan="4">
                                    <telerik:RadComboBox ID="cmbFK_NHANVIENNHAN" runat="server" SelectedValue='<%# CheckNHANVIENNHAN(Eval("FK_NHANVIENNHAN")) %>' 
                                        DataTextField="C_NAME" DataValueField="PK_ID" DataSourceID="UserDataSource" ShowToggleImage="True"
                                        EmptyMessage="Chọn" AllowCustomText="True" Filter="Contains">
                                    </telerik:RadComboBox>
                                </td>
                            ...
                            <tr>
                                ...
                                <td colspan="4">
                                    <telerik:RadComboBox ID="cmbFK_NHANVIENKHAITHAC" runat="server" SelectedValue='<%# CheckNHANVIENKHAITHAC(Eval("FK_NHANVIENKHAITHAC")) %>' 
                                        DataTextField="C_NAME" DataValueField="PK_ID" DataSourceID="UserDataSource" ShowToggleImage="True"
                                        EmptyMessage="Chọn" AllowCustomText="True" Filter="Contains">
                                    </telerik:RadComboBox>
                                </td>
                                ...
                                <td colspan="4">
                                    <telerik:RadComboBox ID="cmbFK_NHANVIENPHAT" runat="server" SelectedValue='<%# CheckNHANVIENPHAT(Eval("FK_NHANVIENPHAT")) %>' 
                                        DataTextField="C_NAME" DataValueField="PK_ID" DataSourceID="UserDataSource" ShowToggleImage="True"
                                        EmptyMessage="Chọn" AllowCustomText="True" Filter="Contains">
                                    </telerik:RadComboBox>
                                </td>
                            ...
                            <tr>
                                ...
                                <td colspan="4">
                                    <telerik:RadComboBox ID="cmbFK_DOITAC" runat="server" SelectedValue='<%# CheckDOITAC(Eval("FK_DOITAC")) %>' 
...
<asp:SqlDataSource ID="MAVUNGDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:DOVEEXPRESSConnectionString %>"></asp:SqlDataSource>
...
<asp:SqlDataSource ID="QUANHUYENDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:DOVEEXPRESSConnectionString %>"></asp:SqlDataSource>
