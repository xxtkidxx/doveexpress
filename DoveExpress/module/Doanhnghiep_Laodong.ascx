<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Doanhnghiep_Laodong.ascx.cs" Inherits="module_Doanhnghiep_Laodong" %>

<telerik:RadCodeBlock ID="RadCodeBlockDoanhnghiepLaodong" runat="server">
<script type="text/javascript">
        function RowDblClickUser(sender, eventArgs) {
            var CanEdit = "<%=ITCLIB.Security.Security.CanEditModule("DoanhNghieps") %>";
            if ((eventArgs.get_tableView().get_name() == "MasterTableViewDoanhnghiepLaodong") && (CanEdit == "True")) {
...
<telerik:RadAjaxLoadingPanel Skin="Vista" ID="RadAjaxLoadingPanelDoanhnghiepLaodong" runat="server" />
...
<telerik:RadGrid ID="RadGridDoanhnghiepLaodong" runat="server" Skin="Windows7" 
    ...
    DataSourceID="DoanhnghiepLaodongDataSource" ShowFooter="True"
    ondatabound="RadGridDoanhnghiepLaodong_DataBound"  
    onitemcommand="RadGridDoanhnghiepLaodong_ItemCommand" CellSpacing="0" 
    onprerender="RadGridDoanhnghiepLaodong_PreRender" 
    onitemupdated="RadGridDoanhnghiepLaodong_ItemUpdated">
...
<Excel Format="ExcelML"></Excel>
    ...
    <MasterTableView Name="MasterTableViewDoanhnghiepLaodong" CommandItemDisplay="Top" DataSourceID="DoanhnghiepLaodongDataSource" DataKeyNames="PK_ID" 
    ClientDataKeyNames="PK_ID" EditMode="InPlace" NoMasterRecordsText="Không có dữ liệu">
        <CommandItemTemplate>
                    <div style="padding: 5px 5px;float:left;width:auto">
                       ...
                       <br /><br /><asp:LinkButton ID="btnEditSelected" runat="server" CommandName="EditSelected" Visible='<%# RadGridDoanhnghiepLaodong.EditIndexes.Count == 0 && ITCLIB.Security.Security.CanEditModule("DoanhNghieps") %>'><img style="border:0px;vertical-align:middle;" alt="" src="Images/Grid/Edit.gif" />Sửa</asp:LinkButton>&nbsp;&nbsp;
                        <asp:LinkButton ID="btnUpdateEdited" runat="server" CommandName="UpdateEdited" Visible='<%# RadGridDoanhnghiepLaodong.EditIndexes.Count > 0 %>'><img style="border:0px;vertical-align:middle;" alt="" src="Images/img_save.jpg" />Lưu</asp:LinkButton>&nbsp;&nbsp;
                        <asp:LinkButton ID="btnCancel" runat="server" CommandName="CancelAll" Visible='<%# RadGridDoanhnghiepLaodong.EditIndexes.Count > 0 || RadGridDoanhnghiepLaodong.MasterTableView.IsItemInserted %>'><img style="border:0px;vertical-align:middle;" alt="" src="Images/Grid/Cancel.gif" />Hủy bỏ</asp:LinkButton>&nbsp;&nbsp;
                        <asp:LinkButton ID="LinkButton2" runat="server" CommandName="InsertCode" Visible='<%# !RadGridDoanhnghiepLaodong.MasterTableView.IsItemInserted && ITCLIB.Security.Security.CanAddModule("DoanhNghieps") %>'><img style="border:0px;vertical-align:middle;" alt="" src="Images/Grid/AddRecord.gif" />Tạo bảng báo cáo</asp:LinkButton>&nbsp;&nbsp;
...
<ColumnGroups>
<telerik:GridColumnGroup HeaderText ="Chia theo trình độ chuyên môn" Name ="chuyenmon" HeaderStyle-Font-Bold ="true" HeaderStyle-HorizontalAlign ="Center"></telerik:GridColumnGroup>
<telerik:GridColumnGroup HeaderText ="Chức danh" Name ="chucdanh" HeaderStyle-Font-Bold ="true" HeaderStyle-HorizontalAlign ="Center"></telerik:GridColumnGroup>
</ColumnGroups>
        <Columns>
     ...
     <telerik:GridTemplateColumn DataField="C_NAME"  ShowFilterIcon ="false" FilterControlWidth ="100%" AutoPostBackOnFilter ="true" 
        FilterControlAltText="Filter C_NAME column" HeaderText=""   SortExpression="C_NAME" UniqueName="C_NAME"  HeaderStyle-Width ="200px" >   
     <ItemTemplate>
    ...
    <telerik:GridBoundColumn DataField="C_DATE" DataType="System.DateTime"  Visible ="false"  ShowFilterIcon ="false" FilterControlWidth ="100%" AutoPostBackOnFilter ="true" 
     ...
     <telerik:GridTemplateColumn DataField="VALUE1"  ShowFilterIcon ="false" FilterControlWidth ="100%" AutoPostBackOnFilter ="true" 
        FilterControlAltText="Filter VALUE1 column" HeaderText="Tổng số"  ItemStyle-Width ="70px" HeaderStyle-Width ="70px" 
     ...
     <telerik:GridTemplateColumn DataField="VALUE2"  ColumnGroupName ="chuyenmon" ShowFilterIcon ="false" FilterControlWidth ="100%" AutoPostBackOnFilter ="true" 
        FilterControlAltText="Filter VALUE2 column" HeaderText="Tiến sĩ"  ItemStyle-Width ="70px" HeaderStyle-Width ="70px" 
     ...
     <telerik:GridTemplateColumn DataField="VALUE3"  ColumnGroupName ="chuyenmon"  ShowFilterIcon ="false" FilterControlWidth ="100%" AutoPostBackOnFilter ="true" 
        FilterControlAltText="Filter VALUE3 column" HeaderText="Thạc sĩ"  ItemStyle-Width ="70px" HeaderStyle-Width ="70px" 
     ...
     <telerik:GridTemplateColumn DataField="VALUE4"  ColumnGroupName ="chuyenmon"  ShowFilterIcon ="false" FilterControlWidth ="100%" AutoPostBackOnFilter ="true" 
        FilterControlAltText="Filter VALUE4 column" HeaderText="Đại học"  ItemStyle-Width ="70px" HeaderStyle-Width ="70px" 
        SortExpression="VALUE4" UniqueName="VALUE4">   
     <ItemTemplate>
            <%#Eval("VALUE4")%>
      </ItemTemplate>
      <EditItemTemplate>
            <telerik:RadNumericTextBox  ID="txtVALUE4" Runat="server" Text ='<%#Bind("VALUE4")%>'
             IncrementSettings-InterceptMouseWheel="true" Width="70px"  CssClass ="csstextNum" MaxValue="500000" MinValue="0" IncrementSettings-InterceptArrowKeys="true" >
             <NumberFormat  DecimalDigits ="0"/>
             </telerik:RadNumericTextBox>
      </EditItemTemplate>
    </telerik:GridTemplateColumn>
     <telerik:GridTemplateColumn DataField="VALUE5"  ColumnGroupName ="chuyenmon"   ShowFilterIcon ="false" FilterControlWidth ="100%" AutoPostBackOnFilter ="true" 
        FilterControlAltText="Filter VALUE5 column" HeaderText="Cao đẳng"  ItemStyle-Width ="70px" HeaderStyle-Width ="70px" 
        SortExpression="VALUE5" UniqueName="VALUE5">   
     <ItemTemplate>
            <%#Eval("VALUE5")%>
      </ItemTemplate>
      <EditItemTemplate>
            <telerik:RadNumericTextBox  ID="txtVALUE5" Runat="server" Text ='<%#Bind("VALUE5")%>'
             IncrementSettings-InterceptMouseWheel="true" Width="70px"  CssClass ="csstextNum" MaxValue="500000" MinValue="0" IncrementSettings-InterceptArrowKeys="true" >
             <NumberFormat  DecimalDigits ="0"/>
             </telerik:RadNumericTextBox>
      </EditItemTemplate>
    </telerik:GridTemplateColumn>
     <telerik:GridTemplateColumn DataField="VALUE6"  ColumnGroupName ="chuyenmon"   ShowFilterIcon ="false" FilterControlWidth ="100%" AutoPostBackOnFilter ="true" 
        FilterControlAltText="Filter VALUE6 column" HeaderText="Trung cấp"  ItemStyle-Width ="70px" HeaderStyle-Width ="70px" 
     ...
     <telerik:GridTemplateColumn DataField="VALUE7"  ColumnGroupName ="chuyenmon"   ShowFilterIcon ="false" FilterControlWidth ="100%" AutoPostBackOnFilter ="true" 
        FilterControlAltText="Filter VALUE7 column" HeaderText="Khác"  ItemStyle-Width ="70px" HeaderStyle-Width ="70px" 
    ...
    <telerik:GridTemplateColumn DataField="VALUE8"  ColumnGroupName ="chucdanh"   ShowFilterIcon ="false" FilterControlWidth ="100%" AutoPostBackOnFilter ="true" 
        FilterControlAltText="Filter VALUE8 column" HeaderText="Giáo sư"  ItemStyle-Width ="70px" HeaderStyle-Width ="70px" 
    ...
    <telerik:GridTemplateColumn DataField="VALUE9"  ColumnGroupName ="chucdanh"   ShowFilterIcon ="false" FilterControlWidth ="100%" AutoPostBackOnFilter ="true" 
        FilterControlAltText="Filter VALUE9 column" HeaderText="Phó giáo sư"  ItemStyle-Width ="70px" HeaderStyle-Width ="70px" 
        SortExpression="VALUE9" UniqueName="VALUE9">   
     <ItemTemplate>
            <%#Eval("VALUE9")%>
      </ItemTemplate>
      <EditItemTemplate>
            <telerik:RadNumericTextBox  ID="txtVALUE9" Runat="server" Text ='<%#Bind("VALUE9")%>'
             IncrementSettings-InterceptMouseWheel="true" Width="70px"  CssClass ="csstextNum" MaxValue="500000" MinValue="0" IncrementSettings-InterceptArrowKeys="true" >
             <NumberFormat  DecimalDigits ="0"/>
             </telerik:RadNumericTextBox>
      </EditItemTemplate>
...
<asp:SqlDataSource ID="DoanhnghiepLaodongDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:CNCREPORTConnectionString %>"
...
<asp:SqlDataSource ID="TieuchilaodongSqlDataSource" runat="server" 
    ConnectionString="<%$ ConnectionStrings:CNCREPORTConnectionString %>" 
    SelectCommand="SELECT * FROM [DOANHNGHIEP_TIEUCHI] WHERE ([C_TYPE] = @C_TYPE)">
    <SelectParameters>
        <asp:Parameter DefaultValue="LAODONG" Name="C_TYPE" Type="String" />
    </SelectParameters>
</asp:SqlDataSource>
