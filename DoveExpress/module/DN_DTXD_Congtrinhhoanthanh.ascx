<%@ Control Language="C#" AutoEventWireup="true" CodeFile="DN_DTXD_Congtrinhhoanthanh.ascx.cs" Inherits="module_DN_DTXD_Congtrinhhoanthanh" %>
<telerik:RadAjaxManagerProxy ID="RadAjaxProxyDTXD_CongtrinhHT" runat="server">
        <AjaxSettings>
            <telerik:AjaxSetting AjaxControlID="RadGridDoanhnghiep_DTXD_CongtrinhHT">
                <UpdatedControls>
                    <telerik:AjaxUpdatedControl ControlID="RadGridDoanhnghiep_DTXD_CongtrinhHT" LoadingPanelID="RadAjaxLoadingPanelDTXD_CongtrinhHT" />
                </UpdatedControls>
            </telerik:AjaxSetting>
        </AjaxSettings>
</telerik:RadAjaxManagerProxy>
<%--Lấy 195 cố định cho tiêu chí : Tại Đầu tư xây dựng 1. Các công trình đã hoàn thành--%>
<telerik:RadAjaxLoadingPanel Skin="Windows7" ID="RadAjaxLoadingPanelDTXD_CongtrinhHT" runat="server" />
<telerik:RadGrid ID="RadGridDoanhnghiep_DTXD_CongtrinhHT" runat="server" Skin="Windows7"
    ...
    DataSourceID="DTXD_CongtrinhHTDataSource" ShowFooter="True"
    ondatabound="RadGridDoanhnghiep_DTXD_CongtrinhHT_DataBound" 
    onitemdeleted="RadGridDoanhnghiep_DTXD_CongtrinhHT_ItemDeleted" oniteminserted="RadGridDoanhnghiep_DTXD_CongtrinhHT_ItemInserted" 
    onitemupdated="RadGridDoanhnghiep_DTXD_CongtrinhHT_ItemUpdated" 
    onitemcommand="RadGridDoanhnghiep_DTXD_CongtrinhHT_ItemCommand" 
    onitemdatabound="RadGridDoanhnghiep_DTXD_CongtrinhHT_ItemDataBound" CellSpacing="0">
    ...
    <MasterTableView Name="MasterTableViewDTXD_CongtrinhHT" CommandItemDisplay="Top" DataSourceID="DTXD_CongtrinhHTDataSource" DataKeyNames="PK_ID" ClientDataKeyNames="PK_ID" EditMode="InPlace" NoMasterRecordsText="Không có dữ liệu">
        <CommandItemTemplate>
                    <div style="padding: 5px 5px;float:left;width:auto">
                        <asp:LinkButton ID="LinkButton2" runat="server" CommandName="InitInsert" Visible='<%# !RadGridDoanhnghiep_DTXD_CongtrinhHT.MasterTableView.IsItemInserted %>'><img style="border:0px;vertical-align:middle;" alt="" src="Images/Grid/AddRecord.gif" />Thêm</asp:LinkButton>&nbsp;&nbsp;                 
 ...
 <telerik:GridBoundColumn DataField="PK_ID" Visible ="false" UniqueName="PK_ID" DataType="System.Int64"></telerik:GridBoundColumn>
   ...
   <ItemStyle Width="50px" /> 
     ...
     <ItemTemplate>
      ...
      <InsertItemTemplate>
            <telerik:RadTextBox  ID="txtVALUE2" Width ="240px" Runat="server" Text ='<%#Bind("VALUE2")%>'></telerik:RadTextBox>
      </InsertItemTemplate>
      <EditItemTemplate>
            <telerik:RadTextBox  ID="txtVALUE2" Width ="240px" Runat="server" Text ='<%#Bind("VALUE2")%>'></telerik:RadTextBox>
      </EditItemTemplate>
...
<asp:SqlDataSource ID="DTXD_CongtrinhHTDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:CNCREPORTConnectionString %>"
        DeleteCommand="DELETE FROM [DOANHNGHIEP_VALUE] WHERE [PK_ID] = @original_PK_ID" 
        InsertCommand="INSERT INTO [DOANHNGHIEP_VALUE] ([FK_DOANHNGHIEP], [FK_TIEUCHI], [C_DATE], [C_DATE_EDIT], [VALUE1], [VALUE2], [VALUE3], [VALUE4], [VALUE5], [VALUE6], [VALUE7], [VALUE8], [VALUE9], [VALUE10], [VALUE11]) VALUES (@FK_DOANHNGHIEP, 195, @C_DATE, @C_DATE_EDIT, @VALUE1, @VALUE2, @VALUE3, @VALUE4, @VALUE5, @VALUE6, @VALUE7, @VALUE8, @VALUE9, @VALUE10, @VALUE11); SELECT @NEWIDDK = SCOPE_IDENTITY(); "
        SelectCommand="SELECT * FROM [DOANHNGHIEP_VALUE] where FK_TIEUCHI ='195' AND VALUE9 IS NOT NULL AND FK_DOANHNGHIEP =@FK_DOANHNGHIEP AND ((CONVERT(NVARCHAR(8), DOANHNGHIEP_VALUE.C_DATE, 112) =  @C_DATE) or (CONVERT (DATETIME, FLOOR(CONVERT (FLOAT, DOANHNGHIEP_VALUE.C_DATE)))  =  CONVERT (DATETIME, FLOOR(CONVERT (FLOAT, GETDATE()))) and (@C_DATE =0)))"        
    ...
    oninserted="DTXD_CongtrinhHTDataSource_Inserted" 
