<%@ Control Language="C#" AutoEventWireup="true" CodeFile="DN_GOPVON_Bennuocngoai.ascx.cs" Inherits="module_DN_GOPVON_Bennuocngoai" %>

<telerik:RadAjaxManagerProxy ID="RadAjaxProxyGopVon_Nuocngoai" runat="server">
        <AjaxSettings>
            <telerik:AjaxSetting AjaxControlID="RadGridDoanhnghiep_GopVon_Nuocngoai">
                <UpdatedControls>
                    <telerik:AjaxUpdatedControl ControlID="RadGridDoanhnghiep_GopVon_Nuocngoai" LoadingPanelID="RadAjaxLoadingPanelGopVon_Nuocngoai" />
                </UpdatedControls>
            </telerik:AjaxSetting>
        </AjaxSettings>
</telerik:RadAjaxManagerProxy>
<%--Lấy 146 cố định cho tiêu chí : Góp vốn 1. Bên nước ngoài--%>
<telerik:RadAjaxLoadingPanel Skin="Windows7" ID="RadAjaxLoadingPanelGopVon_Nuocngoai" runat="server" />
<telerik:RadGrid ID="RadGridDoanhnghiep_GopVon_Nuocngoai" runat="server" Skin="Windows7"
    ...
    DataSourceID="GopVon_NuocngoaiDataSource" ShowFooter="True"
    ondatabound="RadGridDoanhnghiep_GopVon_Nuocngoai_DataBound" 
    onitemdeleted="RadGridDoanhnghiep_GopVon_Nuocngoai_ItemDeleted" oniteminserted="RadGridDoanhnghiep_GopVon_Nuocngoai_ItemInserted" 
    onitemupdated="RadGridDoanhnghiep_GopVon_Nuocngoai_ItemUpdated" 
    onitemcommand="RadGridDoanhnghiep_GopVon_Nuocngoai_ItemCommand" 
    onitemdatabound="RadGridDoanhnghiep_GopVon_Nuocngoai_ItemDataBound" CellSpacing="0">
    ...
    <MasterTableView Name="MasterTableViewGopVon_Nuocngoai" CommandItemDisplay="Top" DataSourceID="GopVon_NuocngoaiDataSource" DataKeyNames="PK_ID" ClientDataKeyNames="PK_ID" EditMode="InPlace" NoMasterRecordsText="Không có dữ liệu">
        <CommandItemTemplate>
                    <div style="padding: 5px 5px;float:left;width:auto">
                        <asp:LinkButton ID="LinkButton2" runat="server" CommandName="InitInsert" Visible='<%# !RadGridDoanhnghiep_GopVon_Nuocngoai.MasterTableView.IsItemInserted %>'><img style="border:0px;vertical-align:middle;" alt="" src="Images/Grid/AddRecord.gif" />Thêm</asp:LinkButton>&nbsp;&nbsp;                 
...
<asp:SqlDataSource ID="GopVon_NuocngoaiDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:CNCREPORTConnectionString %>"
        DeleteCommand="DELETE FROM [DOANHNGHIEP_VALUE] WHERE [PK_ID] = @original_PK_ID" 
        InsertCommand="INSERT INTO [DOANHNGHIEP_VALUE] ([FK_DOANHNGHIEP], [FK_TIEUCHI], [C_DATE], [C_DATE_EDIT], [VALUE1], [VALUE2], [VALUE3], [VALUE4], [VALUE5], [VALUE6], [VALUE7], [VALUE8], [VALUE9], [VALUE10], [VALUE11]) VALUES (@FK_DOANHNGHIEP, 146, @C_DATE, @C_DATE_EDIT, @VALUE1, @VALUE2, @VALUE3, @VALUE4, @VALUE5, @VALUE6, @VALUE7, @VALUE8, @VALUE9, @VALUE10, @VALUE11); SELECT @NEWIDDK = SCOPE_IDENTITY(); "
        SelectCommand="SELECT * FROM [DOANHNGHIEP_VALUE] where FK_TIEUCHI ='146' AND VALUE9 IS NOT NULL AND FK_DOANHNGHIEP =@FK_DOANHNGHIEP AND ((CONVERT(NVARCHAR(8), DOANHNGHIEP_VALUE.C_DATE, 112) =  @C_DATE) or (CONVERT (DATETIME, FLOOR(CONVERT (FLOAT, DOANHNGHIEP_VALUE.C_DATE)))  =  CONVERT (DATETIME, FLOOR(CONVERT (FLOAT, GETDATE()))) and (@C_DATE =0)))"        
    ...
    oninserted="GopVon_NuocngoaiDataSource_Inserted" 
