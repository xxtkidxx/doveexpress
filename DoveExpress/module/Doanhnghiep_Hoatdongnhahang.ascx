<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Doanhnghiep_Hoatdongnhahang.ascx.cs" Inherits="module_Doanhnghiep_Hoatdongnhahang" %>


<telerik:RadCodeBlock ID="RadCodeBlockDoanhnghiepNhahang" runat="server">
<script type="text/javascript">
        function RowDblClickUser(sender, eventArgs) {
            var CanEdit = "<%=ITCLIB.Security.Security.CanEditModule("DoanhNghieps") %>";
            if ((eventArgs.get_tableView().get_name() == "MasterTableViewDoanhnghiepNhahang") && (CanEdit == "True")) {
...
<telerik:RadAjaxLoadingPanel Skin="Vista" ID="RadAjaxLoadingPanelDoanhnghiepNhahang" runat="server" />
...
<telerik:RadGrid ID="RadGridDoanhnghiepNhahang" runat="server" Skin="Windows7" 
    ...
    DataSourceID="DoanhnghiepNhahangDataSource" ShowFooter="True"
    ondatabound="RadGridDoanhnghiepNhahang_DataBound"  
    onitemcommand="RadGridDoanhnghiepNhahang_ItemCommand" CellSpacing="0" 
    onprerender="RadGridDoanhnghiepNhahang_PreRender" 
    onitemupdated="RadGridDoanhnghiepNhahang_ItemUpdated">
...
<Excel Format="ExcelML"></Excel>
    ...
    <MasterTableView Name="MasterTableViewDoanhnghiepNhahang" CommandItemDisplay="Top" DataSourceID="DoanhnghiepNhahangDataSource" DataKeyNames="PK_ID" 
    ClientDataKeyNames="PK_ID" EditMode="InPlace" NoMasterRecordsText="Không có dữ liệu">
        <CommandItemTemplate>
                    <div style="padding: 5px 5px;float:left;width:auto">
                       ...
                       <br /><br /><asp:LinkButton ID="btnEditSelected" runat="server" CommandName="EditSelected" Visible='<%# RadGridDoanhnghiepNhahang.EditIndexes.Count == 0 && ITCLIB.Security.Security.CanEditModule("DoanhNghieps") %>'><img style="border:0px;vertical-align:middle;" alt="" src="Images/Grid/Edit.gif" />Sửa</asp:LinkButton>&nbsp;&nbsp;
                        <asp:LinkButton ID="btnUpdateEdited" runat="server" CommandName="UpdateEdited" Visible='<%# RadGridDoanhnghiepNhahang.EditIndexes.Count > 0 %>'><img style="border:0px;vertical-align:middle;" alt="" src="Images/img_save.jpg" />Lưu</asp:LinkButton>&nbsp;&nbsp;
                        <asp:LinkButton ID="btnCancel" runat="server" CommandName="CancelAll" Visible='<%# RadGridDoanhnghiepNhahang.EditIndexes.Count > 0 || RadGridDoanhnghiepNhahang.MasterTableView.IsItemInserted %>'><img style="border:0px;vertical-align:middle;" alt="" src="Images/Grid/Cancel.gif" />Hủy bỏ</asp:LinkButton>&nbsp;&nbsp;
                        <asp:LinkButton ID="LinkButton2" runat="server" CommandName="InsertCode" Visible='<%# !RadGridDoanhnghiepNhahang.MasterTableView.IsItemInserted && ITCLIB.Security.Security.CanAddModule("DoanhNghieps") %>'><img style="border:0px;vertical-align:middle;" alt="" src="Images/Grid/AddRecord.gif" />Tạo bảng báo cáo</asp:LinkButton>&nbsp;&nbsp;
...
<ExpandCollapseColumn FilterControlAltText="Filter ExpandColumn column"></ExpandCollapseColumn>
     ...
     <telerik:GridTemplateColumn DataField="C_NAME"  ShowFilterIcon ="false" FilterControlWidth ="100%" AutoPostBackOnFilter ="true" 
        FilterControlAltText="Filter C_NAME column" HeaderText=""  ItemStyle-Width ="300px" HeaderStyle-Width ="300px"  
     ...
     <telerik:GridTemplateColumn DataField="C_UNIT"  ShowFilterIcon ="false" FilterControlWidth ="100%" AutoPostBackOnFilter ="true" 
        FilterControlAltText="Filter C_UNIT column" HeaderText="Đơn vị"  ItemStyle-Width ="150px" HeaderStyle-Width ="150px" 
...
<asp:SqlDataSource ID="DoanhnghiepNhahangDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:CNCREPORTConnectionString %>"
