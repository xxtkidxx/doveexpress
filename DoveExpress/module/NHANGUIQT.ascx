...
<telerik:RadGrid ID="RadGridNHANGUIQT" runat="server" Skin="Vista" 
    ...
    <MasterTableView Name="MasterTableViewNHANGUIQT" CommandItemDisplay="Top" DataSourceID="NHANGUIQTDataSource" DataKeyNames="PK_ID,C_BILL" ClientDataKeyNames="PK_ID,C_BILL" EditMode="PopUp" NoMasterRecordsText="Không có dữ liệu">
        <CommandItemTemplate>
