<%@ Control Language="C#" AutoEventWireup="true" CodeFile="DUANVON.ascx.cs" Inherits="module_DUANVON" %>
<telerik:RadAjaxManagerProxy ID="RadAjaxProxyDUANVON" runat="server">
        <AjaxSettings>
            <telerik:AjaxSetting AjaxControlID="RadGridDUANVON">
                <UpdatedControls>
                    <telerik:AjaxUpdatedControl ControlID="RadGridDUANVON" LoadingPanelID="RadAjaxLoadingPanelDUANVON" />
                </UpdatedControls>
            </telerik:AjaxSetting>
        </AjaxSettings>
</telerik:RadAjaxManagerProxy>
<telerik:RadAjaxLoadingPanel Skin="Windows7" ID="RadAjaxLoadingPanelDUANVON" runat="server" />
<telerik:RadGrid ID="RadGridDUANVON" runat="server" Skin="Windows7"
    AllowPaging="True" PageSize="20" AllowSorting="True" 
    AllowFilteringByColumn="True" GridLines="None" ShowStatusBar="true"
    AutoGenerateColumns="False"  
    AllowMultiRowEdit="True" AllowAutomaticDeletes="True" 
    AllowAutomaticInserts="True" AllowAutomaticUpdates="True" 
    DataSourceID="DUANVONsDataSource" ShowFooter="True"
    ondatabound="RadGridDUANVON_DataBound" 
    onitemdeleted="RadGridDUANVON_ItemDeleted" oniteminserted="RadGridDUANVON_ItemInserted" 
    onitemupdated="RadGridDUANVON_ItemUpdated" 
    onitemcommand="RadGridDUANVON_ItemCommand" 
    onitemdatabound="RadGridDUANVON_ItemDataBound">
    ...
    <MasterTableView Name="MasterTableViewDUANVON" CommandItemDisplay="Top" DataSourceID="DUANVONsDataSource" DataKeyNames="PK_ID" ClientDataKeyNames="PK_ID" EditMode="InPlace" NoMasterRecordsText="Không có dữ liệu">
        <CommandItemTemplate>
                    <div style="padding: 5px 5px;float:left;width:auto">
                        <b>Chi tiết nguồn vốn</b>&nbsp;&nbsp;&nbsp;&nbsp;       
                        <asp:LinkButton ID="LinkButton2" runat="server" CommandName="InitInsert" Visible='<%# !RadGridDUANVON.MasterTableView.IsItemInserted %>'><img style="border:0px;vertical-align:middle;" alt="" src="Images/Grid/AddRecord.gif" />Thêm</asp:LinkButton>&nbsp;&nbsp;                 
...
<asp:SqlDataSource ID="DUANVONsDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:CNCREPORTConnectionString %>"
        DeleteCommand="DELETE FROM DUANVON WHERE PK_ID = @PK_ID" 
        InsertCommand="INSERT INTO DUANVON (FK_NGUONVON,TONGTIEN,FK_DUAN) VALUES (@FK_NGUONVON,@TONGTIEN,@FK_DUAN);SELECT @NEWIDVON = SCOPE_IDENTITY()"
        SelectCommand="SELECT DUANVON.PK_ID,DUANVON.FK_NGUONVON,DUANVON.TONGTIEN,DMNGUONVON.C_NAME as NGUONVON FROM DUANVON LEFT OUTER JOIN DMNGUONVON ON DMNGUONVON.PK_ID = DUANVON.FK_NGUONVON WHERE FK_DUAN=@FK_DUAN"
        
    UpdateCommand="UPDATE DUANVON SET FK_NGUONVON=@FK_NGUONVON,TONGTIEN=@TONGTIEN WHERE PK_ID = @PK_ID" 
    oninserted="DUANVONsDataSource_Inserted">
        <UpdateParameters>
        ...
        <InsertParameters>      
            ...
            <asp:Parameter Name="TONGTIEN" Type="String" />
            <asp:ControlParameter Name="FK_DUAN" Type="Int32" ControlID="txtID" DefaultValue="0"/>
            <asp:Parameter Name="NEWIDVON" Type="Int32" Direction="Output" DefaultValue="0"/>
        </InsertParameters>
</asp:SqlDataSource>
