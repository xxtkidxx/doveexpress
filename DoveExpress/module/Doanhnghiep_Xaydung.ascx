<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Doanhnghiep_Xaydung.ascx.cs" Inherits="module_Doangnghiep_Xaydung" %>



<telerik:RadCodeBlock ID="RadCodeBlockDoanhnghiepXaydung" runat="server">
<script type="text/javascript">
        function RowDblClickUser(sender, eventArgs) {
            var CanEdit = "<%=ITCLIB.Security.Security.CanEditModule("DoanhNghieps") %>";
            if ((eventArgs.get_tableView().get_name() == "MasterTableViewDoanhnghiepXaydung") && (CanEdit == "True")) {
...
<telerik:RadAjaxLoadingPanel Skin="Vista" ID="RadAjaxLoadingPanelDoanhnghiepXaydung" runat="server" />
...
<telerik:RadGrid ID="RadGridDoanhnghiepXaydung" runat="server" Skin="Windows7" 
    ...
    DataSourceID="DoanhnghiepXaydungDataSource" ShowFooter="True"
    ondatabound="RadGridDoanhnghiepXaydung_DataBound"  
    onitemcommand="RadGridDoanhnghiepXaydung_ItemCommand" CellSpacing="0" 
    onprerender="RadGridDoanhnghiepXaydung_PreRender" 
    onitemupdated="RadGridDoanhnghiepXaydung_ItemUpdated"  onitemdatabound="RadGridDoanhnghiepXaydung_ItemDataBound">
...
<Excel Format="ExcelML"></Excel>
    ...
    <MasterTableView Name="MasterTableViewDoanhnghiepXaydung" CommandItemDisplay="Top" DataSourceID="DoanhnghiepXaydungDataSource" DataKeyNames="PK_ID,C_CODE,C_TABLE"
    ClientDataKeyNames="PK_ID,C_CODE,C_TABLE" EditMode="InPlace" NoMasterRecordsText="Không có dữ liệu">
        <CommandItemTemplate>
                    <div style="padding: 5px 5px;float:left;width:auto">
                       ...
                       <br /><br /><asp:LinkButton ID="btnEditSelected" runat="server" CommandName="EditSelected" Visible='<%# RadGridDoanhnghiepXaydung.EditIndexes.Count == 0 && ITCLIB.Security.Security.CanEditModule("DoanhNghieps") %>'><img style="border:0px;vertical-align:middle;" alt="" src="Images/Grid/Edit.gif" />Sửa</asp:LinkButton>&nbsp;&nbsp;
                        <asp:LinkButton ID="btnUpdateEdited" runat="server" CommandName="UpdateEdited" Visible='<%# RadGridDoanhnghiepXaydung.EditIndexes.Count > 0 %>'><img style="border:0px;vertical-align:middle;" alt="" src="Images/img_save.jpg" />Lưu</asp:LinkButton>&nbsp;&nbsp;
                        <asp:LinkButton ID="btnCancel" runat="server" CommandName="CancelAll" Visible='<%# RadGridDoanhnghiepXaydung.EditIndexes.Count > 0 || RadGridDoanhnghiepXaydung.MasterTableView.IsItemInserted %>'><img style="border:0px;vertical-align:middle;" alt="" src="Images/Grid/Cancel.gif" />Hủy bỏ</asp:LinkButton>&nbsp;&nbsp;
                        <asp:LinkButton ID="LinkButton2" runat="server" CommandName="InsertCode" Visible='<%# !RadGridDoanhnghiepXaydung.MasterTableView.IsItemInserted && ITCLIB.Security.Security.CanAddModule("DoanhNghieps") %>'><img style="border:0px;vertical-align:middle;" alt="" src="Images/Grid/AddRecord.gif" />Tạo bảng báo cáo</asp:LinkButton>&nbsp;&nbsp;
...
<ExpandCollapseColumn FilterControlAltText="Filter ExpandColumn column"></ExpandCollapseColumn>
 <Columns>
    ...
    <telerik:GridTemplateColumn DataField="C_UNIT"  ShowFilterIcon ="false" FilterControlWidth ="100%" AutoPostBackOnFilter ="true" 
        FilterControlAltText="Filter C_UNIT column" HeaderText="Đơn vị"  ItemStyle-Width ="80px" HeaderStyle-Width ="80px" 
     ...
     <telerik:GridTemplateColumn DataField="VALUE1"  ShowFilterIcon ="false" FilterControlWidth ="100%" AutoPostBackOnFilter ="true" 
        FilterControlAltText="Filter VALUE1 column" HeaderText="Thực hiện"  ItemStyle-Width ="60px" HeaderStyle-Width ="60px" 
...
<asp:Panel ID = "panelheader_b2" runat ="server">
        <tr>
        <td rowspan ="2" style ="font-weight:bold; width:70px;" class="tddece2">Tổng số</td>
            <td colspan ="4" class="tddece_nlast" style ="font-weight:bold;">
...
<asp:Panel ID = "panelheader_b3" runat ="server">
        <tr>
        <td rowspan ="2" style ="font-weight:bold; width:70px;" class="tddece2">Tổng doanh thu thuần</td>
            <td colspan ="4" class="tddece_nlast" style ="font-weight:bold;">
            Chia ra</td>
            <td></td>
        </tr>
        <tr>        
           <td style ="font-weight:bold;" class="tddece2" colspan ="2">
            Bán buôn
            </td>
            <td style ="font-weight:bold;" class="tddecelast" colspan ="2">
            Bán lẻ
            </td>
        </tr>
</asp:Panel>
        <tr>
            <td>            
             ...
             <telerik:RadNumericTextBox  ID="txtVALUE7" Runat="server" Text ='<%#Bind("VALUE7")%>' Enabled ='<%#(bool)Eval("C_ISTYPE") %>' 
            IncrementSettings-InterceptMouseWheel="true"  Width="70px"  CssClass ="csstextNum" MaxValue="500000" MinValue="0" IncrementSettings-InterceptArrowKeys="true" >
            <NumberFormat  DecimalDigits ="0"/>
            </telerik:RadNumericTextBox>          
            </td>
            <td>
             ...
             <telerik:RadNumericTextBox  ID="txtVALUE8" Runat="server" Text ='<%#Bind("VALUE8")%>' Enabled ='<%#(bool)Eval("C_ISTYPE") %>' 
            IncrementSettings-InterceptMouseWheel="true"  Width="70px"  CssClass ="csstextNum" MaxValue="500000" MinValue="0" IncrementSettings-InterceptArrowKeys="true" >
            <NumberFormat  DecimalDigits ="0"/>
            </telerik:RadNumericTextBox>        
            </td>
            ...
            <telerik:RadNumericTextBox  ID="txtVALUE9" Runat="server" Text ='<%#Bind("VALUE9")%>' Enabled ='<%#(bool)Eval("C_ISTYPE") %>' 
            IncrementSettings-InterceptMouseWheel="true"  Width="70px"  CssClass ="csstextNum" MaxValue="500000" MinValue="0" IncrementSettings-InterceptArrowKeys="true" >
            <NumberFormat  DecimalDigits ="0"/>
            </telerik:RadNumericTextBox>
            </td>
 <asp:Panel ID = "paneltxt" runat ="server">
            <td>
             <telerik:RadNumericTextBox  ID="txtVALUE5" Runat="server" Text ='<%#Bind("VALUE5")%>' Enabled ='<%#(bool)Eval("C_ISTYPE") %>' 
            IncrementSettings-InterceptMouseWheel="true"  Width="70px"  CssClass ="csstextNum" MaxValue="500000" MinValue="0" IncrementSettings-InterceptArrowKeys="true" >
            <NumberFormat  DecimalDigits ="0"/>
            </telerik:RadNumericTextBox>
            </td>
            <td>
            <telerik:RadNumericTextBox  ID="txtVALUE6" Runat="server" Text ='<%#Bind("VALUE6")%>' Enabled ='<%#(bool)Eval("C_ISTYPE") %>' 
            IncrementSettings-InterceptMouseWheel="true"  Width="70px"  CssClass ="csstextNum" MaxValue="500000" MinValue="0" IncrementSettings-InterceptArrowKeys="true" >
            <NumberFormat  DecimalDigits ="0"/>
            </telerik:RadNumericTextBox>
            </td>
...
<asp:SqlDataSource ID="DoanhnghiepXaydungDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:CNCREPORTConnectionString %>"
