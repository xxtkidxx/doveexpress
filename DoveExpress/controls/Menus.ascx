...
<telerik:RadMenu ID="Menu" Runat="server" Skin="Office2010Black" CssClass ="cssMenuNgang" Width="99.9%"  style="position:absolute;z-index: 1">
    ...
    <Items>
      <telerik:RadMenuItem runat="server" Font-Size="Small" Text="Danh mục chung" Value="DANHMUCCHUNG" ImageUrl="~/images/home.png">
        <Items>
            ...
            <telerik:RadMenuItem runat="server" Font-Size="Small" NavigateUrl="../Default.aspx?ctl=TRANGTHAIBILL" Text="Trạng thái Bill" Value="TRANGTHAIBILL">
            </telerik:RadMenuItem>
    ...
    <telerik:RadMenuItem runat="server" Font-Size="Small" Text="Báo cáo" Value="BAOCAO">   
        <Items>
            ...
            <telerik:RadMenuItem runat="server" Font-Size="Small" NavigateUrl="../Default.aspx?ctl=BAOCAOTTTT" Text="Tình trạng thanh toán" Value="BAOCAOTTTT">
            </telerik:RadMenuItem>
