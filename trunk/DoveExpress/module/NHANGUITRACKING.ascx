...
<telerik:RadGrid ID="RadGridNHANGUITRACKING" runat="server" Skin="Vista" AllowPaging="True"
    ...
    <MasterTableView Name="MasterTableViewNHANGUITRACKING" CommandItemDisplay="Top" DataSourceID="NHANGUITRACKINGDataSource"
        ...
        <CommandItemTemplate>
            <div style="padding: 5px 5px; float: left; width: auto">
                <b>Tracking Bill</b>&nbsp;&nbsp;&nbsp;&nbsp;
                <asp:LinkButton ID="btnEditSelected" runat="server" CommandName="EditSelected" Visible='<%# RadGridNHANGUITRACKING.EditIndexes.Count == 0 && ITCLIB.Security.Security.CanEditModule("NHANGUI") %>'><img style="border:0px;vertical-align:middle;" alt="" src="Images/Grid/Edit.gif" />Sửa</asp:LinkButton>&nbsp;&nbsp;
                ...
                <asp:LinkButton ID="LinkButton2" runat="server" CommandName="InitInsert" Visible='<%# !RadGridNHANGUITRACKING.MasterTableView.IsItemInserted && ITCLIB.Security.Security.CanAddModule("NHANGUI") %>'><img style="border:0px;vertical-align:middle;" alt="" src="Images/Grid/AddRecord.gif" />Thêm</asp:LinkButton>&nbsp;&nbsp;
    ...
    <ClientSettings AllowKeyboardNavigation="true" KeyboardNavigationSettings-AllowSubmitOnEnter="true"
        ...
        <KeyboardNavigationSettings AllowSubmitOnEnter="True"></KeyboardNavigationSettings>
    </ClientSettings>
