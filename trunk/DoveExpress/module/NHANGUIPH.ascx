    ...
    <MasterTableView Name="MasterTableViewNHANGUIPH" CommandItemDisplay="Top" DataSourceID="NHANGUIPHDataSource"
        ...
        <Columns>
            ...
            <telerik:GridBoundColumn UniqueName="C_DIACHINHAN" HeaderText="Địa chỉ nhận" DataField="C_DIACHINHAN"
             ...
             <telerik:GridTemplateColumn UniqueName="TRANGTHAINAME" HeaderText="Trạng thái cuối" DataField="PK_ID" HeaderStyle-Width="110px" HeaderStyle-HorizontalAlign="Center" AllowFiltering="False">
                    <ItemTemplate>
                        <asp:Label ID="lblTrangThai" runat="server" Text='<%# LoadTrangThai(Eval("C_BILL"),Eval("FK_TRANGTHAI")) %>'></asp:Label>
                    </ItemTemplate>
                </telerik:GridTemplateColumn>     
