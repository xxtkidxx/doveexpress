                ...
                if (check)
                {
                    for (int i = 0; i < oDataTable.Rows.Count; i++)
                    {
                        ...
                        if (C_BILL != "")
                        {
                            ...
                            {
                                lblMessageAddExcell.Text = "Bill tại dòng thứ " + (i + 1) + " không là dạng số." + C_BILL;
                                check = false;
                            }
                        }
                    }
