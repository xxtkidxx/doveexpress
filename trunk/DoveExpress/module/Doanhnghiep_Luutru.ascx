<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Doanhnghiep_Luutru.ascx.cs" Inherits="module_Doanhnghiep_Luutru" %>

<telerik:RadCodeBlock ID="RadCodeBlockDoanhnghiepLuutru" runat="server">
<script type="text/javascript">
        function RowDblClickUser(sender, eventArgs) {
            var CanEdit = "<%=ITCLIB.Security.Security.CanEditModule("DoanhNghieps") %>";
            if ((eventArgs.get_tableView().get_name() == "MasterTableViewDoanhnghiepLuutru") && (CanEdit == "True")) {
...
<telerik:RadAjaxLoadingPanel Skin="Vista" ID="RadAjaxLoadingPanelDoanhnghiepLuutru" runat="server" />
...
<telerik:RadGrid ID="RadGridDoanhnghiepLuutru" runat="server" Skin="Windows7" 
    ...
    DataSourceID="DoanhnghiepLuutruDataSource" ShowFooter="True"
    ondatabound="RadGridDoanhnghiepLuutru_DataBound"  
    onitemcommand="RadGridDoanhnghiepLuutru_ItemCommand" CellSpacing="0" 
    onprerender="RadGridDoanhnghiepLuutru_PreRender" 
    onitemupdated="RadGridDoanhnghiepLuutru_ItemUpdated"  onitemdatabound="RadGridDoanhnghiepLuutru_ItemDataBound">
...
<Excel Format="ExcelML"></Excel>
    ...
    <MasterTableView Name="MasterTableViewDoanhnghiepLuutru" CommandItemDisplay="Top" DataSourceID="DoanhnghiepLuutruDataSource" DataKeyNames="PK_ID" 
    ClientDataKeyNames="PK_ID" EditMode="InPlace" NoMasterRecordsText="Không có dữ liệu">
        <CommandItemTemplate>
                    <div style="padding: 5px 5px;float:left;width:auto">
                       ...
                       <br /><br /><asp:LinkButton ID="btnEditSelected" runat="server" CommandName="EditSelected" Visible='<%# RadGridDoanhnghiepLuutru.EditIndexes.Count == 0 && ITCLIB.Security.Security.CanEditModule("DoanhNghieps") %>'><img style="border:0px;vertical-align:middle;" alt="" src="Images/Grid/Edit.gif" />Sửa</asp:LinkButton>&nbsp;&nbsp;
                        <asp:LinkButton ID="btnUpdateEdited" runat="server" CommandName="UpdateEdited" Visible='<%# RadGridDoanhnghiepLuutru.EditIndexes.Count > 0 %>'><img style="border:0px;vertical-align:middle;" alt="" src="Images/img_save.jpg" />Lưu</asp:LinkButton>&nbsp;&nbsp;
                        <asp:LinkButton ID="btnCancel" runat="server" CommandName="CancelAll" Visible='<%# RadGridDoanhnghiepLuutru.EditIndexes.Count > 0 || RadGridDoanhnghiepLuutru.MasterTableView.IsItemInserted %>'><img style="border:0px;vertical-align:middle;" alt="" src="Images/Grid/Cancel.gif" />Hủy bỏ</asp:LinkButton>&nbsp;&nbsp;
                        <asp:LinkButton ID="LinkButton2" runat="server" CommandName="InsertCode" Visible='<%# !RadGridDoanhnghiepLuutru.MasterTableView.IsItemInserted && ITCLIB.Security.Security.CanAddModule("DoanhNghieps") %>'><img style="border:0px;vertical-align:middle;" alt="" src="Images/Grid/AddRecord.gif" />Tạo bảng báo cáo</asp:LinkButton>&nbsp;&nbsp;
...
<ExpandCollapseColumn FilterControlAltText="Filter ExpandColumn column"></ExpandCollapseColumn>
 <Columns>
     ...
     <telerik:GridTemplateColumn DataField="C_NAME"  ShowFilterIcon ="false" FilterControlWidth ="100%" AutoPostBackOnFilter ="true" 
        FilterControlAltText="Filter C_NAME column" HeaderText=""  HeaderStyle-Width ="290px" 
    ...
    <telerik:GridTemplateColumn DataField="C_UNIT"  ShowFilterIcon ="false" FilterControlWidth ="100%" AutoPostBackOnFilter ="true" 
     ...
     <ItemTemplate>
      ...
      <EditItemTemplate>
          <%#Eval("C_UNIT")%>
           <asp:Label runat="server" ID ="lblVALUE2" Font-Bold="true"  Text="Số cơ sở có đến cuối năm  (cơ sở)"></asp:Label>
            <telerik:RadNumericTextBox  ID="txtVALUE2" Runat="server" Text ='<%#Bind("VALUE2")%>'
             IncrementSettings-InterceptMouseWheel="true"  Width="70px"  CssClass ="csstextNum" MaxValue="5000" MinValue="0" ShowSpinButtons="false" IncrementSettings-InterceptArrowKeys="true" >
...
<asp:Panel ID = "panelheader" runat ="server">
        <tr>
        <td rowspan ="2" style ="font-weight:bold;" class="tddece2">Số buồng có đến cuối (buồng)</td>
        <td rowspan ="2" style ="font-weight:bold;" class="tddece2">Số giường có đến cuối  (giường)</td>
            <td colspan ="2" class="tddece" style ="font-weight:bold;">
            Số lượt khách phục vụ trong năm (Chỉ tính khách có ngủ qua đêm) -(Lượt khách)
            </td>
            <td colspan ="2" class="tddece_nlast" style ="font-weight:bold;">
...
<asp:SqlDataSource ID="DoanhnghiepLuutruDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:CNCREPORTConnectionString %>"
