<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Doanhnghiep_Tainan.ascx.cs" Inherits="module_Doanhgnhiep_Tainan" %>


<telerik:RadCodeBlock ID="RadCodeBlockDoanhnghiepTainan" runat="server">
<script type="text/javascript">
        function RowDblClickUser(sender, eventArgs) {
            var CanEdit = "<%=ITCLIB.Security.Security.CanEditModule("DoanhNghieps") %>";
            if ((eventArgs.get_tableView().get_name() == "MasterTableViewDoanhnghiepTainan") && (CanEdit == "True")) {
...
<telerik:RadAjaxLoadingPanel Skin="Vista" ID="RadAjaxLoadingPanelDoanhnghiepTainan" runat="server" />
...
<telerik:RadGrid ID="RadGridDoanhnghiepTainan" runat="server" Skin="Windows7" 
    ...
    DataSourceID="DoanhnghiepTainanDataSource" ShowFooter="True"
    ondatabound="RadGridDoanhnghiepTainan_DataBound"  
    onitemcommand="RadGridDoanhnghiepTainan_ItemCommand" CellSpacing="0" 
    onprerender="RadGridDoanhnghiepTainan_PreRender" 
    onitemupdated="RadGridDoanhnghiepTainan_ItemUpdated">
...
<Excel Format="ExcelML"></Excel>
    ...
    <MasterTableView Name="MasterTableViewDoanhnghiepTainan" CommandItemDisplay="Top" DataSourceID="DoanhnghiepTainanDataSource" DataKeyNames="PK_ID" 
    ClientDataKeyNames="PK_ID" EditMode="InPlace" NoMasterRecordsText="Không có dữ liệu">
        <CommandItemTemplate>
                    <div style="padding: 5px 5px;float:left;width:auto">
                       ...
                       <br /><br /><asp:LinkButton ID="btnEditSelected" runat="server" CommandName="EditSelected" Visible='<%# RadGridDoanhnghiepTainan.EditIndexes.Count == 0 && ITCLIB.Security.Security.CanEditModule("DoanhNghieps") %>'><img style="border:0px;vertical-align:middle;" alt="" src="Images/Grid/Edit.gif" />Sửa</asp:LinkButton>&nbsp;&nbsp;
                        <asp:LinkButton ID="btnUpdateEdited" runat="server" CommandName="UpdateEdited" Visible='<%# RadGridDoanhnghiepTainan.EditIndexes.Count > 0 %>'><img style="border:0px;vertical-align:middle;" alt="" src="Images/img_save.jpg" />Lưu</asp:LinkButton>&nbsp;&nbsp;
                        <asp:LinkButton ID="btnCancel" runat="server" CommandName="CancelAll" Visible='<%# RadGridDoanhnghiepTainan.EditIndexes.Count > 0 || RadGridDoanhnghiepTainan.MasterTableView.IsItemInserted %>'><img style="border:0px;vertical-align:middle;" alt="" src="Images/Grid/Cancel.gif" />Hủy bỏ</asp:LinkButton>&nbsp;&nbsp;
                        <asp:LinkButton ID="LinkButton2" runat="server" CommandName="InsertCode" Visible='<%# !RadGridDoanhnghiepTainan.MasterTableView.IsItemInserted && ITCLIB.Security.Security.CanAddModule("DoanhNghieps") %>'><img style="border:0px;vertical-align:middle;" alt="" src="Images/Grid/AddRecord.gif" />Tạo bảng báo cáo</asp:LinkButton>&nbsp;&nbsp;
...
<ExpandCollapseColumn FilterControlAltText="Filter ExpandColumn column"></ExpandCollapseColumn>
     ...
     <telerik:GridTemplateColumn DataField="C_NAME"  ShowFilterIcon ="false" FilterControlWidth ="100%" AutoPostBackOnFilter ="true" 
        FilterControlAltText="Filter C_NAME column" HeaderText="" SortExpression="C_NAME" UniqueName="C_NAME" ItemStyle-Width ="270px" HeaderStyle-Width ="270px" >   
     <ItemTemplate>
     ...
     <telerik:GridTemplateColumn DataField="C_CODE"  ShowFilterIcon ="false" FilterControlWidth ="100%" AutoPostBackOnFilter ="true" 
        FilterControlAltText="Filter C_CODE column" HeaderText="Mã"  HeaderStyle-Width ="60px" 
    ...
    <telerik:GridBoundColumn DataField="C_DATE" DataType="System.DateTime"  Visible ="false"  ShowFilterIcon ="false" FilterControlWidth ="100%" AutoPostBackOnFilter ="true" 
     ...
     <telerik:GridTemplateColumn DataField="VALUE2"  ShowFilterIcon ="false" FilterControlWidth ="100%" AutoPostBackOnFilter ="true" 
        FilterControlAltText="Filter VALUE2 column" HeaderText="Thực hiện"  ItemStyle-Width ="70px" HeaderStyle-Width ="70px" 
        SortExpression="VALUE2" UniqueName="VALUE2">   
     <ItemTemplate>
            <%#Eval("VALUE2")%>
      </ItemTemplate>
      <EditItemTemplate>
            <telerik:RadNumericTextBox  ID="txtVALUE2" Runat="server" Text ='<%#Bind("VALUE2")%>' Visible ='<%#Eval("C_ISTYPE") %>'
...
<asp:SqlDataSource ID="DoanhnghiepTainanDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:CNCREPORTConnectionString %>"
