<%@ Control Language="C#" AutoEventWireup="true" CodeFile="DoanhNghiep_Gopvon.ascx.cs" Inherits="module_DoanhNghiep_Gopvon" %>
<%@ Register TagPrefix="uc1" TagName="bennuocngoai" Src="DN_DTXD_Congtrinhhoanthanh.ascx" %>

<telerik:RadCodeBlock ID="RadCodeBlockDoanhnghiepGOPVON" runat="server">
<script type="text/javascript">
        function RowDblClickUser(sender, eventArgs) {
            var CanEdit = "<%=ITCLIB.Security.Security.CanEditModule("DoanhNghieps") %>";
            if ((eventArgs.get_tableView().get_name() == "MasterTableViewDoanhnghiepGOPVON") && (CanEdit == "True")) {
...
<telerik:RadAjaxLoadingPanel Skin="Vista" ID="RadAjaxLoadingPanelDoanhnghiepGOPVON" runat="server" />
...
<telerik:RadGrid ID="RadGridDoanhnghiepGOPVON" runat="server" Skin="Windows7" 
    ...
    DataSourceID="DoanhnghiepGOPVONDataSource" ShowFooter="True"
    ondatabound="RadGridDoanhnghiepGOPVON_DataBound"  
    onitemcommand="RadGridDoanhnghiepGOPVON_ItemCommand" CellSpacing="0" 
    onprerender="RadGridDoanhnghiepGOPVON_PreRender" 
    onitemupdated="RadGridDoanhnghiepGOPVON_ItemUpdated"  onitemdatabound="RadGridDoanhnghiepGOPVON_ItemDataBound">
...
<Excel Format="ExcelML"></Excel>
    ...
    <MasterTableView Name="MasterTableViewDoanhnghiepGOPVON" CommandItemDisplay="Top" DataSourceID="DoanhnghiepGOPVONDataSource" DataKeyNames="PK_ID,C_CODE,C_TABLE"
    ClientDataKeyNames="PK_ID,C_CODE,C_TABLE" EditMode="InPlace" NoMasterRecordsText="Không có dữ liệu">
        <CommandItemTemplate>
                    <div style="padding: 5px 5px;float:left;width:auto">
                       ...
                       <br /><br /><asp:LinkButton ID="btnEditSelected" runat="server" CommandName="EditSelected" Visible='<%# RadGridDoanhnghiepGOPVON.EditIndexes.Count == 0 && ITCLIB.Security.Security.CanEditModule("DoanhNghieps") %>'><img style="border:0px;vertical-align:middle;" alt="" src="Images/Grid/Edit.gif" />Sửa</asp:LinkButton>&nbsp;&nbsp;
                        <asp:LinkButton ID="btnUpdateEdited" runat="server" CommandName="UpdateEdited" Visible='<%# RadGridDoanhnghiepGOPVON.EditIndexes.Count > 0 %>'><img style="border:0px;vertical-align:middle;" alt="" src="Images/img_save.jpg" />Lưu</asp:LinkButton>&nbsp;&nbsp;
                        <asp:LinkButton ID="btnCancel" runat="server" CommandName="CancelAll" Visible='<%# RadGridDoanhnghiepGOPVON.EditIndexes.Count > 0 || RadGridDoanhnghiepGOPVON.MasterTableView.IsItemInserted %>'><img style="border:0px;vertical-align:middle;" alt="" src="Images/Grid/Cancel.gif" />Hủy bỏ</asp:LinkButton>&nbsp;&nbsp;
                        <asp:LinkButton ID="LinkButton2" runat="server" CommandName="InsertCode" Visible='<%# !RadGridDoanhnghiepGOPVON.MasterTableView.IsItemInserted && ITCLIB.Security.Security.CanAddModule("DoanhNghieps") %>'><img style="border:0px;vertical-align:middle;" alt="" src="Images/Grid/AddRecord.gif" />Tạo bảng báo cáo</asp:LinkButton>&nbsp;&nbsp;
...
<ExpandCollapseColumn FilterControlAltText="Filter ExpandColumn column"></ExpandCollapseColumn>
 <Columns>
     ...
     <ItemTemplate>
      ...
      <EditItemTemplate>
           <%#getName(Eval("C_NAME"),Eval("C_LEVEL").ToString(),Eval("C_HEADER"))%>
           <uc1:bennuocngoai  ID ="idgopvon" runat ="server" /> 
      </EditItemTemplate>
    ...
    <telerik:GridBoundColumn DataField="C_DATE" DataType="System.DateTime"  Visible ="false"  ShowFilterIcon ="false" FilterControlWidth ="100%" AutoPostBackOnFilter ="true" 
        ...
        FilterControlAltText="Filter C_CODE column" HeaderText="Mã"  ItemStyle-Width ="30px" HeaderStyle-Width ="30px" 
    ...
    <telerik:GridTemplateColumn DataField="C_UNIT"  ShowFilterIcon ="false" FilterControlWidth ="100%" AutoPostBackOnFilter ="true" 
        FilterControlAltText="Filter C_UNIT column" HeaderText="Đơn vị tính"  ItemStyle-Width ="70px" HeaderStyle-Width ="70px" 
     ...
     <telerik:GridTemplateColumn DataField="VALUE1"  ShowFilterIcon ="false" FilterControlWidth ="100%" AutoPostBackOnFilter ="true" 
        FilterControlAltText="Filter VALUE1 column" HeaderText="Vốn theo giấy phép đến 31/12/2005"   ItemStyle-Width ="100px" HeaderStyle-Width ="100px" 
...
<asp:Panel ID = "panelheader_b2" runat ="server">
        <tr>
        <td style=" text-align :center; font-weight:bold;">Thực hiện</td>        
        </tr>
</asp:Panel>
        <tr>
        ...
        FilterControlAltText="Filter VALUE2 column" HeaderText="Vốn thực hiện lũy kế đến 31/12/2005"  ItemStyle-Width ="100px" HeaderStyle-Width ="100px" 
...
<asp:SqlDataSource ID="DoanhnghiepGOPVONDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:CNCREPORTConnectionString %>"
