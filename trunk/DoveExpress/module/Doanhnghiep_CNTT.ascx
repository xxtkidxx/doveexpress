<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Doanhnghiep_CNTT.ascx.cs" Inherits="module_Doanhnghiep_CNTT" %>



<telerik:RadCodeBlock ID="RadCodeBlockDoanhnghiepCNTT" runat="server">
<script type="text/javascript">
        function RowDblClickUser(sender, eventArgs) {
            var CanEdit = "<%=ITCLIB.Security.Security.CanEditModule("DoanhNghieps") %>";
            if ((eventArgs.get_tableView().get_name() == "MasterTableViewDoanhnghiepCNTT") && (CanEdit == "True")) {
...
<telerik:RadAjaxLoadingPanel Skin="Vista" ID="RadAjaxLoadingPanelDoanhnghiepCNTT" runat="server" />
...
<telerik:RadGrid ID="RadGridDoanhnghiepCNTT" runat="server" Skin="Windows7" 
    ...
    DataSourceID="DoanhnghiepCNTTDataSource" ShowFooter="True"
    ondatabound="RadGridDoanhnghiepCNTT_DataBound"  
    onitemcommand="RadGridDoanhnghiepCNTT_ItemCommand" CellSpacing="0" 
    onprerender="RadGridDoanhnghiepCNTT_PreRender" 
    onitemupdated="RadGridDoanhnghiepCNTT_ItemUpdated" 
    onitemdatabound="RadGridDoanhnghiepCNTT_ItemDataBound">
...
<Excel Format="ExcelML"></Excel>
    ...
    <MasterTableView Name="MasterTableViewDoanhnghiepCNTT" CommandItemDisplay="Top" DataSourceID="DoanhnghiepCNTTDataSource" DataKeyNames="PK_ID" 
    ClientDataKeyNames="PK_ID" EditMode="InPlace" NoMasterRecordsText="Không có dữ liệu">
        <CommandItemTemplate>
                    <div style="padding: 5px 5px;float:left;width:auto">
                       ...
                       <br /><br /><asp:LinkButton ID="btnEditSelected" runat="server" CommandName="EditSelected" Visible='<%# RadGridDoanhnghiepCNTT.EditIndexes.Count == 0 && ITCLIB.Security.Security.CanEditModule("DoanhNghieps") %>'><img style="border:0px;vertical-align:middle;" alt="" src="Images/Grid/Edit.gif" />Sửa</asp:LinkButton>&nbsp;&nbsp;
                        <asp:LinkButton ID="btnUpdateEdited" runat="server" CommandName="UpdateEdited" Visible='<%# RadGridDoanhnghiepCNTT.EditIndexes.Count > 0 %>'><img style="border:0px;vertical-align:middle;" alt="" src="Images/img_save.jpg" />Lưu</asp:LinkButton>&nbsp;&nbsp;
                        <asp:LinkButton ID="btnCancel" runat="server" CommandName="CancelAll" Visible='<%# RadGridDoanhnghiepCNTT.EditIndexes.Count > 0 || RadGridDoanhnghiepCNTT.MasterTableView.IsItemInserted %>'><img style="border:0px;vertical-align:middle;" alt="" src="Images/Grid/Cancel.gif" />Hủy bỏ</asp:LinkButton>&nbsp;&nbsp;
                        <asp:LinkButton ID="LinkButton2" runat="server" CommandName="InsertCode" Visible='<%# !RadGridDoanhnghiepCNTT.MasterTableView.IsItemInserted && ITCLIB.Security.Security.CanAddModule("DoanhNghieps") %>'><img style="border:0px;vertical-align:middle;" alt="" src="Images/Grid/AddRecord.gif" />Tạo bảng báo cáo</asp:LinkButton>&nbsp;&nbsp;
...
<ExpandCollapseColumn FilterControlAltText="Filter ExpandColumn column"></ExpandCollapseColumn>
     ...
     <telerik:GridTemplateColumn DataField="C_NAME"  ShowFilterIcon ="false" FilterControlWidth ="100%" AutoPostBackOnFilter ="true" 
        FilterControlAltText="Filter C_NAME column" HeaderText=""  HeaderStyle-Width ="150px" 
    ...
    <telerik:GridBoundColumn DataField="C_DATE" DataType="System.DateTime"  Visible ="false"  ShowFilterIcon ="false" FilterControlWidth ="100%" AutoPostBackOnFilter ="true" 
     ...
     <telerik:GridTemplateColumn DataField="VALUE1" AllowFiltering ="false" ShowFilterIcon ="false" FilterControlWidth ="100%" AutoPostBackOnFilter ="true" 
        FilterControlAltText="Filter VALUE1 column" HeaderText=""  ItemStyle-Width ="70%" HeaderStyle-Width ="70%" 
        SortExpression="VALUE1" UniqueName="VALUE1">   
     <ItemTemplate>
            <%#Eval("VALUE1")%>
      </ItemTemplate>
      <EditItemTemplate>
          <asp:HiddenField ID="hfCode" runat="server" Value ='<%#Eval("C_CODE")%>' />
          <asp:Label ID="Label2" runat="server" Text=></asp:Label>
           <telerik:RadNumericTextBox  ID="txtVALUE2" Runat="server" Text ='<%#Bind("VALUE2")%>' 
             IncrementSettings-InterceptMouseWheel="true" Width="100px" MaxValue="5000" MinValue="1" ShowSpinButtons="true" IncrementSettings-InterceptArrowKeys="true" >
             <NumberFormat  DecimalDigits ="0"/>
           </telerik:RadNumericTextBox>
             <asp:Label ID="lblRequest" runat="server" Text='<%#Eval("C_UNIT") %>'></asp:Label>
           <asp:RadioButtonList ID="RadStatus" runat="server" RepeatDirection="Horizontal" SelectedValue ='<%# Bind("VALUE1") %>'>
                        <asp:ListItem Text="" Value ="" style =" display:none;"></asp:ListItem>
                        <asp:ListItem Text ="Không (2)" Value ="2"></asp:ListItem>
                        <asp:ListItem Text ="Có (1) _ Nhập thông tin dưới đây" Value ="1"></asp:ListItem>                        
             </asp:RadioButtonList>   
             <telerik:RadTextBox runat ="server" ID = "txtVALUE3" Width ="70%" Text ='<%#Bind("VALUE3")%>'></telerik:RadTextBox>
      </EditItemTemplate>
    </telerik:GridTemplateColumn>             
        </Columns>
        </MasterTableView>
...
<asp:SqlDataSource ID="DoanhnghiepCNTTDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:CNCREPORTConnectionString %>"
